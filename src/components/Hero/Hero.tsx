...
const Hero: FC<SectionHero2Props> = ({className = "", data}) => {
    ...
    const renderItem = (index: number) => {
        ...
        return (
            <div
                className={`mt-0  nc-SectionHero2Item nc-SectionHero2Item--animation flex flex-col-reverse lg:flex-col relative overflow-hidden w-full  aspect-w-16 aspect-h-7 md:aspect-h-4 ${className}`}
                key={index}
            >
